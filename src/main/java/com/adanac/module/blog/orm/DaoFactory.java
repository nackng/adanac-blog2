package com.adanac.module.blog.orm;
...
public abstract class DaoFactory {
	...
	static {
		File[] files = Configuration.getClasspathFile("com/adanac/module/blog/dao").listFiles();
		for (int i = 0; i < files.length; i++) {
			...
			try {
				Class<?> clazz = Configuration.getClassLoader().loadClass("com.adanac.module.blog.dao." + fileName);
