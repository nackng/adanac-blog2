...
public abstract class Generators {
	...
	static {
		...
		File[] files = Configuration.getClasspathFile("com/adanac/module/blog/generator").listFiles();
		for (int i = 0; i < files.length; i++) {
			...
			try {
				Class<?> clazz = Configuration.getClassLoader()
						.loadClass("com.adanac.module.blog.generator." + fileName);
