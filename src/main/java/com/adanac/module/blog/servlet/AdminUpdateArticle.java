...
public class AdminUpdateArticle extends AbstractServlet {
	...
	protected void service() throws ServletException, IOException {
        ...
        Integer articleId = DaoFactory.getDao(ArticleDao.class).saveOrUpdate(id, subject, Status.valueOf(Integer.valueOf(status)), Type.valueOf(Integer.valueOf(type)), Integer.valueOf(updateCreateTime), "adanac", html, stringBuffer.toString(), icon);
