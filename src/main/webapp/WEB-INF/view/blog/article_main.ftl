    ...
    <div class="index_about">
        ...
        <#if preArticle?? >
            <div class="nextinfo">
                <p>上一篇：<a href="${base}${preArticle.url}">${preArticle.subject}</a></p>
            </div>
        </#if>
        <#if nextArticle?? >
            <div class="nextinfo">
                <p>下一篇：<a href="${base}${nextArticle.url}">${nextArticle.subject}</a></p>
            </div>
        </#if>
            ...
            <div class="otherlink">
                ...
                <ul>
                    <#list relatedArticles as article>
                        <li><a href="${base}${article.url}" title="${article.subject}">${article.subject}</a></li>
                    </#list>
                </ul>
            </div>
        </#if>
